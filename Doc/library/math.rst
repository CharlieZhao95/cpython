...
.. data:: nan
   ...
   not considered to equal to any other value, including themselves. To avoid errors
   when checking whether a number is NaN, use the :func:`isnan` function to test
